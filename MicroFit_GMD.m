...
%The function `MicroFit` was modified by Ehsan Eqlimi to return the **Global Map Dissimilarity (GMD)** as a second output argument.

function [L, GMD] = MicroFit_GMD(X, A, polarity)
